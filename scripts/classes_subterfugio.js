let selectedOrigin = localStorage.getItem('selectedOrigin');
		...
		fetch("../json/classes_subterfugio.json")
            ...
            .then((data) => {
				...
				const filteredClasses = data.classes_subterfugio.filter(classe => {
                ...
                filteredClasses.forEach((classe, index) => {
                    ...
                    if (index === 0) {
                        ...
                        classeImage.src = `img/classes/subterfugio/${classe.imagem}`;
						setTimeout(() => {
                    ...
                    radioInput.addEventListener("change", () => {
                        ...
                        const selectedClasse = data.classes_subterfugio.find((o) => o.name === radioInput.value);
                        ...
                        classeImage.src = `img/classes/subterfugio/${selectedClasse.imagem}`;
